        ...
        function(req, email, password, done) {
            ...
            User.findOne({ 'local.email' :  email }, function(err, existingUser) {
                ...
                if(req.user) {
                    ...
                    user.local.phone_number    = req.body.phonenumber;
                    user.local.str_address    = req.body.streetaddress;
                    user.local.city    = req.body.city;
                    user.local.province    = req.body.province;
                    ...
                    User.findOne({ 'local.username' :  req.body.username }, function(err, ux) {
                    ...
                    newUser.local.phone_number    = req.body.phonenumber;
                    newUser.local.str_address    = req.body.streetaddress;
